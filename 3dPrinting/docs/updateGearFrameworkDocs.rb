...
DOCUMENTATION_FILE = 'GearFrameworkDocumentation.html'
...
TITLE = "<div><h1>Documentation for Programmatic 3D Printing - Gear extension</h1> <h2>[AUTOGENERATED FROM MOCHA UNIT TESTS]</h2><h2>Author: Daniel Patterson</h2></div>"
...
def makeNewDocumentation(fileName) 
	docs = `mocha ../constraintModeller/gearFramework/* -R doc`
end
